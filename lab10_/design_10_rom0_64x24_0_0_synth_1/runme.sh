...
HD_PWD='D:/lab10_/design_10_rom0_64x24_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_10_rom0_64x24_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_10_rom0_64x24_0_0.tcl
