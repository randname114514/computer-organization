...
HD_PWD='D:/cd2/design_2_carry_output_splitter_2_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_carry_output_splitter_2_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_carry_output_splitter_2_1.tcl
