...
HD_PWD='D:/lab_ini_2/design_int_1_xor2_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_int_1_xor2_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_int_1_xor2_0_3.tcl
