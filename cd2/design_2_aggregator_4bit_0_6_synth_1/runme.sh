...
HD_PWD='D:/cd2/design_2_aggregator_4bit_0_6_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_aggregator_4bit_0_6.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_aggregator_4bit_0_6.tcl
