...
#ifndef _cg_fpga_xlconcat_3_0_core_h_
#define _cg_fpga_xlconcat_3_0_core_h_
...
class cg_fpga_xlconcat_3_0_core : public sc_module 
{
    public: 
       cg_fpga_xlconcat_3_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(cg_fpga_xlconcat_3_0_core);
    ...
    virtual ~cg_fpga_xlconcat_3_0_core() = default;
   
    void concate_input_port_values()
    {
        sc_bv <29> portConcateVal;
