...
HD_PWD='D:/cd3/design_3_the_16bit_to_4x4bit_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_the_16bit_to_4x4bit_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_the_16bit_to_4x4bit_0_1.tcl
