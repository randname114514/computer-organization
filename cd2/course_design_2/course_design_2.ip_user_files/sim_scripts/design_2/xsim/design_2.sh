...
#
# Script generated by Vivado on Thu Oct 16 09:06:47 +0800 2025
...
simulate()
{
  xsim design_2 -key {Behavioral:sim_1:Functional:design_2} -tclbatch cmd.tcl -protoinst "protoinst_files/design_2.protoinst" -protoinst "protoinst_files/zlcfq_inst_0.protoinst" -protoinst "protoinst_files/zlcfq_inst_1.protoinst" -log simulate.log
}
