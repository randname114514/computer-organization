...
HD_PWD='D:/lab6/design_6_xor2_0_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_6_xor2_0_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_6_xor2_0_4.tcl
