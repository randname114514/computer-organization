...
HD_PWD='D:/cd2/design_2_and_gate_0_30_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_and_gate_0_30.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_and_gate_0_30.tcl
