...
HD_PWD='D:/lab14/design_14_adpt_out_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_14_adpt_out_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_14_adpt_out_0_0.tcl
