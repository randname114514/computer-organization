...
HD_PWD='D:/lab5_5/design_5_cg_fpga_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_5_cg_fpga_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_5_cg_fpga_0_0.tcl
