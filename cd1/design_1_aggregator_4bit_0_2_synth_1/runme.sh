...
HD_PWD='D:/cd1/design_1_aggregator_4bit_0_2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_aggregator_4bit_0_2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_aggregator_4bit_0_2.tcl
