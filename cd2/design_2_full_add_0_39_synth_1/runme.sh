...
HD_PWD='D:/cd2/design_2_full_add_0_39_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_2_full_add_0_39.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_2_full_add_0_39.tcl
