...
HD_PWD='D:/cd1/design_1_aggregate_4x4_to_16b_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_aggregate_4x4_to_16b_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_aggregate_4x4_to_16b_0_0.tcl
