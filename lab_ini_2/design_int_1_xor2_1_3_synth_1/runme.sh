...
HD_PWD='D:/lab_ini_2/design_int_1_xor2_1_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_int_1_xor2_1_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_int_1_xor2_1_3.tcl
