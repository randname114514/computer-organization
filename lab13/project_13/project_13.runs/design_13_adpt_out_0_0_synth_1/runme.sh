...
HD_PWD='D:/lab13/project_13/project_13.runs/design_13_adpt_out_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_13_adpt_out_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_13_adpt_out_0_0.tcl
