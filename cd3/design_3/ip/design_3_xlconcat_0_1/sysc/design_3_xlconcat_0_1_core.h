...
#ifndef _design_3_xlconcat_0_1_core_h_
#define _design_3_xlconcat_0_1_core_h_
...
class design_3_xlconcat_0_1_core : public sc_module 
{
    public: 
       design_3_xlconcat_0_1_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , In1    ( "In1" )
              , In2    ( "In2" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(design_3_xlconcat_0_1_core);
    ...
    virtual ~design_3_xlconcat_0_1_core() = default;
