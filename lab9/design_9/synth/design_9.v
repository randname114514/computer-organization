...
//Date        : Thu Mar 13 18:59:06 2025
//Host        : jyx running 64-bit major release  (build 9200)
//Command     : generate_target design_9.bd
//Design      : design_9
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "design_9,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_9,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=5,numReposBlks=5,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=4,numPkgbdBlks=1,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_9.hwdef" *) 
module design_9
   (DDR_0_addr,
    DDR_0_ba,
    DDR_0_cas_n,
  ...
  design_9_CNT4B_0_0 CNT4B_0
       (.CLK(adpt_in_0_clk),
        .ENA(adpt_in_0_ena),
        .OUTY(CNT4B_0_OUTY),
        .RST(adpt_in_0_rst));
  design_9_DECL7SEG_0_0 DECL7SEG_0
       (.A(CNT4B_0_OUTY),
        .LED7S(DECL7SEG_0_LED7S));
  design_9_adpt_in_0_0 adpt_in_0
  ...
  design_9_adpt_out_0_0 adpt_out_0
       (.LED7S(DECL7SEG_0_LED7S),
        .seg_cs(adpt_out_0_seg_cs),
        .seg_data(adpt_out_0_seg_data));
  design_9_cg_fpga_0_0 cg_fpga_0
       (.DDR_addr(DDR_0_addr),
        .DDR_ba(DDR_0_ba),
