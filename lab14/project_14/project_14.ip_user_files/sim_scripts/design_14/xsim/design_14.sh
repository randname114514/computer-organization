...
#
# Script generated by Vivado on Mon Mar 17 10:17:55 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : design_14.sh
...
#
# Usage        : design_14.sh
#                design_14.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_14.sh [-reset_run]
#                design_14.sh [-reset_log]
#                design_14.sh [-help]
#
...
# script info
echo -e "design_14.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_14.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_lite_ipif_v3_0_4 -L lib_cdc_v1_0_3 -L interrupt_control_v3_1_5 -L axi_gpio_v2_0_35 -L lib_pkg_v1_0_4 -L lib_srl_fifo_v1_0_4 -L axi_uartlite_v2_0_37 -L axi_intc_v4_1_20 -L proc_sys_reset_v5_0_16 -L generic_baseblocks_v2_1_2 -L axi_infrastructure_v1_1_0 -L axi_register_slice_v2_1_33 -L fifo_generator_v13_2_11 -L axi_data_fifo_v2_1_32 -L axi_crossbar_v2_1_34 -L axi_protocol_converter_v2_1_33 -L xlconcat_v2_1_6 -L v_vid_in_axi4s_v5_0_5 -L xlslice_v1_0_4 -L xlconstant_v1_1_9 -L lib_fifo_v1_0_20 -L blk_mem_gen_v8_4_9 -L lib_bmg_v1_0_18 -L axi_datamover_v5_1_35 -L axi_vdma_v6_3_21 -L axi_vip_v1_1_19 -L processing_system7_vip_v1_0_21 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_14 xil_defaultlib.design_14 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_14 -key {Behavioral:sim_1:Functional:design_14} -tclbatch cmd.tcl -protoinst "protoinst_files/design_14.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib axi_lite_ipif_v3_0_4 lib_cdc_v1_0_3 interrupt_control_v3_1_5 axi_gpio_v2_0_35 lib_pkg_v1_0_4 lib_srl_fifo_v1_0_4 axi_uartlite_v2_0_37 axi_intc_v4_1_20 proc_sys_reset_v5_0_16 generic_baseblocks_v2_1_2 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_33 fifo_generator_v13_2_11 axi_data_fifo_v2_1_32 axi_crossbar_v2_1_34 axi_protocol_converter_v2_1_33 xlconcat_v2_1_6 v_vid_in_axi4s_v5_0_5 xlslice_v1_0_4 xlconstant_v1_1_9 lib_fifo_v1_0_20 blk_mem_gen_v8_4_9 lib_bmg_v1_0_18 axi_datamover_v5_1_35 axi_vdma_v6_3_21 axi_vip_v1_1_19 processing_system7_vip_v1_0_21)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb design_14.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_14.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_14.sh [-help]\n\
Usage: design_14.sh [-step]\n\
Usage: design_14.sh [-lib_map_path]\n\
Usage: design_14.sh [-reset_run]\n\
Usage: design_14.sh [-reset_log]\n\
Usage: design_14.sh [-keep_index]\n\
Usage: design_14.sh [-noclean_files]\n\n\
