...
HD_PWD='D:/lab13/design_13_cg_fpga_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_13_cg_fpga_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_13_cg_fpga_0_0.tcl
