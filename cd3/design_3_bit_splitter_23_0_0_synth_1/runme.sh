...
HD_PWD='D:/cd3/design_3_bit_splitter_23_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_bit_splitter_23_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_bit_splitter_23_0_0.tcl
