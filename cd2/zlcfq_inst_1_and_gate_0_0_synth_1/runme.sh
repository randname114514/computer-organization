...
HD_PWD='D:/cd2/zlcfq_inst_1_and_gate_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zlcfq_inst_1_and_gate_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zlcfq_inst_1_and_gate_0_0.tcl
