...
//Date        : Sat Mar 15 10:30:58 2025
//Host        : jyx running 64-bit major release  (build 9200)
//Command     : generate_target design_10.bd
//Design      : design_10
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "design_10,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_10,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=1,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_10.hwdef" *) 
module design_10
   (DDR_0_addr,
    DDR_0_ba,
    DDR_0_cas_n,
  ...
  design_10_cg_fpga_0_0 cg_fpga_0
       (.DDR_addr(DDR_0_addr),
        .DDR_ba(DDR_0_ba),
        ...
        .vid_vblank(1'b0),
        .vid_vsync(1'b0));
  design_10_rom0_64x24_0_0 rom0_64x24_0
       (.address(Net),
