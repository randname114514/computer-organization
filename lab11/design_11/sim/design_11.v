...
//Command     : generate_target design_11.bd
//Design      : design_11
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "design_11,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_11,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=3,numPkgbdBlks=1,bdsource=USER,da_clkrst_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_11.hwdef" *) 
module design_11
   (DDR_0_addr,
    DDR_0_ba,
    DDR_0_cas_n,
  ...
  design_11_adpt_in_0_1 adpt_in_0
       (.addr(adpt_in_0_addr),
  ...
  design_11_cg_fpga_0_0 cg_fpga_0
       (.DDR_addr(DDR_0_addr),
        ...
        .vid_vblank(1'b0),
        .vid_vsync(1'b0));
  design_11_ram_dp0_256x8_0_0 ram_dp0_256x8_0
