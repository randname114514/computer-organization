...
#
# Script generated by Vivado on Sat Mar 15 10:08:46 +0800 2025
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L blk_mem_gen_v8_4_9 -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot rom0 xil_defaultlib.rom0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim rom0 -key {Behavioral:sim_1:Functional:rom0} -tclbatch cmd.tcl -protoinst "protoinst_files/design_10.protoinst" -log simulate.log
}
