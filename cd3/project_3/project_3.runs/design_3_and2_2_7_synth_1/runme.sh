...
HD_PWD='E:/cd3/project_3/project_3.runs/design_3_and2_2_7_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_3_and2_2_7.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_3_and2_2_7.tcl
