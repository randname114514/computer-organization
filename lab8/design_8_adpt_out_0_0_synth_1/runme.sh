...
HD_PWD='D:/lab8/design_8_adpt_out_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_8_adpt_out_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_8_adpt_out_0_0.tcl
