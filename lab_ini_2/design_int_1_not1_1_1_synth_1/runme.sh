...
HD_PWD='D:/lab_ini_1/design_int_1_not1_1_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_int_1_not1_1_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_int_1_not1_1_1.tcl
