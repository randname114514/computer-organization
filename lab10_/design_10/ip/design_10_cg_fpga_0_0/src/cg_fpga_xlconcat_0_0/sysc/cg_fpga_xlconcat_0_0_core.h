...
#ifndef _cg_fpga_xlconcat_0_0_core_h_
#define _cg_fpga_xlconcat_0_0_core_h_
...
class cg_fpga_xlconcat_0_0_core : public sc_module 
{
    public: 
       cg_fpga_xlconcat_0_0_core (sc_core::sc_module_name nm, const xsc::common_cpp::properties& props)
            : sc_module(nm)
              , In0    ( "In0" )
              , dout   ( "dout" )
    {
        SC_HAS_PROCESS(cg_fpga_xlconcat_0_0_core);
        SC_METHOD(concate_input_port_values);
            sensitive << In0 ;
        dont_initialize();
    }

    virtual ~cg_fpga_xlconcat_0_0_core() = default;
