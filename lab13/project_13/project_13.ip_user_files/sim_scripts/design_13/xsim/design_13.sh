...
#
# Script generated by Vivado on Sun Mar 16 21:43:40 +0800 2025
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : design_13.sh
...
#
# Usage        : design_13.sh
#                design_13.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                design_13.sh [-reset_run]
#                design_13.sh [-reset_log]
#                design_13.sh [-help]
#
...
# script info
echo -e "design_13.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./design_13.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb design_13.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./design_13.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: design_13.sh [-help]\n\
Usage: design_13.sh [-step]\n\
Usage: design_13.sh [-lib_map_path]\n\
Usage: design_13.sh [-reset_run]\n\
Usage: design_13.sh [-reset_log]\n\
Usage: design_13.sh [-keep_index]\n\
Usage: design_13.sh [-noclean_files]\n\n\
