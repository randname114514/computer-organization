...
HD_PWD='D:/lab11/design_11_ram_dp0_256x8_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_11_ram_dp0_256x8_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_11_ram_dp0_256x8_0_0.tcl
