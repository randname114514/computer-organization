...
(* CORE_GENERATION_INFO = "design_13,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_13,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=7,numPkgbdBlks=1,bdsource=USER,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_13.hwdef" *) 
module design_13
   ();

  wire [23:0]UIR_0_q;
  wire [7:0]addr_adpt_0_addr_pc1;
  wire adpt_in_0_clk;
  ...
  design_13_m74LS161_1_0 m74LS161_1
       (.A0(xlconstant_0_dout),
        ...
        .Q3(m74LS161_1_Q3),
        .RCO(m74LS161_1_RCO));
  design_13_rom2_256x24_0_0 rom2_256x24_0
       (.address(addr_adpt_0_addr_pc1),
