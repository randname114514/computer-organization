...
HD_PWD='E:/lab12/design_12_adpt_out_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_12_adpt_out_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_12_adpt_out_0_0.tcl
