...
HD_PWD='D:/lab4_plus/design_4_xor2_2_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_4_xor2_2_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_4_xor2_2_1.tcl
