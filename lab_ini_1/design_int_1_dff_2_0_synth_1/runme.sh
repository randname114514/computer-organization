...
HD_PWD='D:/lab_ini_1/design_int_1_dff_2_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_int_1_dff_2_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_int_1_dff_2_0.tcl
