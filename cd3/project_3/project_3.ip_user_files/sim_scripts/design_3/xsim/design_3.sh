...
#
# Script generated by Vivado on Tue Nov 25 16:53:59 +0800 2025
...
# script info
echo -e "design_3.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xlconstant_v1_1_9 -L xlconcat_v2_1_6 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_3 xil_defaultlib.design_3 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_3 -key {Behavioral:sim_2:Functional:design_3} -tclbatch cmd.tcl -protoinst "protoinst_files/design_3.protoinst" -log simulate.log
}
